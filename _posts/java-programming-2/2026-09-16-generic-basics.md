...
수업 시작하면서 교수님께서 "제네릭과 컬렉션을 해본 적 없다, 배웠는데 까먹었다" 하는 사람 손 들어보라고 하셨다. 자바에서 ArrayList를 써봤으면 제네릭을 안 썼을 리가 없는데, 기억이 안 날 거라고 하셨다. 나도 `List<String>`은 많이 써봤지만 `<T>`가 정확히 뭘 하는 건지 설명하라고 하면 막혔을 것 같다.
